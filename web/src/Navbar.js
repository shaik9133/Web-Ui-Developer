  ...
  return (
    <div className="flex justify-between items-center bg-gray-800 p-4 ">
      <div className="flex items-center space-x-4">
        ...
        <input
          type="text"
          className="bg-gray-700 h-8 px-2 rounded"
          placeholder="search..."
        />
      </div>
      <div className="flex space-x-4">
        ...
        <img
          src="https://lms.indianeconomy.net/wp-content/uploads/wplms_assignments_folder/4770/7577/profile.png"
          alt="User Avatar"
